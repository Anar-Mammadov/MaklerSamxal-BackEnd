...
{
    public static class MaklerDbSeed
    {
        public static IApplicationBuilder SeedMembership(this IApplicationBuilder builder)
        {
            ...
            using (var scope = builder.ApplicationServices.CreateScope())
            {
                ...
                var roleManager = scope.ServiceProvider.GetRequiredService<RoleManager<MaklerRole>>();  //Role idare etmek ucun RoleManager isdifade olunur.
                ...
                var userManager = scope.ServiceProvider.GetRequiredService<UserManager<MaklerUser>>();

                string password = "123";

                // Yeni user yaradiriq.
                var user = new MaklerUser
                {
